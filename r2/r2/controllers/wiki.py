...
page_descriptions = {
    "config/stylesheet": _("This page is the subforum stylesheet, changes here apply to the subforum css"),
    "config/submit_text": _("The contents of this page appear on the submit page"),
    "config/sidebar": _("The contents of this page appear on the subforum sidebar"),
    "config/description": _("The contents of this page appear in the public subforum description and when the user does not have access to the subforum"),
    "config/automoderator": _("This page is used to configure AutoModerator for the subforum, please see [the full documentation](/wiki/automoderator/full-documentation) for information"),
}
    ...
    def GET_wiki_create(self, wp, page):
        ...
        if wp[0]:
            ...
            if error['reason'] == 'PAGE_NAME_LENGTH':
                ...
                error_msg = _("this page is a special page, please go into the subforum settings and save the field once to create this special page")
