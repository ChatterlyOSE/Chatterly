...
error_list = dict((
        ...
        ('SUBREDDIT_EXISTS', _('that subforum already exists')),
        ('SUBREDDIT_NOEXIST', _('that subforum doesn\'t exist')),
        ('SUBREDDIT_NOTALLOWED', _("you aren't allowed to post there.")),
        ('SUBREDDIT_NO_ACCESS', _("you aren't allowed access to this subforum")),
        ('SUBREDDIT_REQUIRED', _('you must specify a subforum')),
        ('SUBREDDIT_DISABLED_ADS', _('this subforum has chosen to disable their ads at this time')),
        ...
        ('OVERSOLD', _('that subforum has already been oversold on %(start)s to %(end)s. Please pick another subforum or date.')),
        ...
        ('NO_SELFS', _("that subforum doesn't allow text posts")),
        ('NO_LINKS', _("that subforum only allows text posts")),
        ...
        ('NO_INVITE_FOUND', _('there is no pending invite for that subforum')),
        ...
        ('MULTI_TOO_MANY_SUBREDDITS', _('no more space for subforums in that multireddit')),
        ('MULTI_SPECIAL_SUBREDDIT', _("can't add special subforum %(path)s")),
        ('TOO_MANY_SUBREDDITS', _('maximum %(max)s subforums')),
        ...
        ('BANNED_FROM_SUBREDDIT', _('that user is banned from the subforum')),
        ...
        ('GILDING_NOT_ALLOWED', _("gilding is not allowed in this subforum")),
        ('SCRAPER_ERROR', _("unable to scrape provided url")),
        ('NO_SR_TO_SR_MESSAGE', _("can't send a message from a subforum to another subforum")),
        ('USER_BLOCKED_MESSAGE', _("can't send message to that user")),
        ('ADMIN_REQUIRED', _("you must be in admin mode for this")),
        ('CANT_CONVERT_TO_GOLD_ONLY', _("to convert an existing subforum to gold only, send a message to %(admin_modmail)s") 
            % dict(admin_modmail=g.admin_message_acct)),
        ('GOLD_ONLY_SR_REQUIRED', _("this subforum must be 'gold only' to select this")),
        ('CANT_CREATE_SR', _("your account is too new or you do not have enough karma to create a subforum. please contact the admins to request an exemption.")),
        ...
        ('USER_MUTED', _("You have been muted from this subforum.")),
        ('MUTED_FROM_SUBREDDIT', _("This user has been muted from the subforum.")),
        ('COMMENT_NOT_STICKYABLE', _("This comment is not stickyable. Ensure that it is a top level comment.")),
        ('SR_RULE_EXISTS', _("A subforum rule by that name already exists.")),
        ('SR_RULE_DOESNT_EXIST', _("No subforum rule by that name exists.")),
        ('SR_RULE_TOO_MANY', _("This subforum already has the maximum number of rules.")),
